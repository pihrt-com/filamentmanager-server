...
final class LocationController
{
    ...
    public function index(Request $request, ?string $id = null): void
    {
        ...
        $filters=['manufacturers'=>$this->options($allInventory,'manufacturer_id','manufacturer_name'),'types'=>$this->values($allInventory,'material_type'),'locations'=>$this->options($allInventory,'location_id','location_name'),'colors'=>$this->values($allInventory,'color_name'),'selected'=>$selected];
