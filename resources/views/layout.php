...
<title><?= View::e($title ?? View::t('app_name')) ?></title><link rel="icon" type="image/png" href="<?= View::e($basePath ?? '') ?>/assets/app-icon.png"><link rel="stylesheet" href="<?= View::e($basePath ?? '') ?>/assets/app.css?v=<?= View::e(trim((string) @file_get_contents(FM_ROOT . '/VERSION'))) ?>">
</head><body id="top">
...
<?php if ($user['role'] === 'admin'): ?><a class="nav-button<?= str_starts_with($requestPath,'/admin/users')?' active':'' ?>" href="<?= View::e($basePath ?? '') ?>/admin/users"><?= View::t('users') ?></a><a class="nav-button<?= str_starts_with($requestPath,'/admin/audit')?' active':'' ?>" href="<?= View::e($basePath ?? '') ?>/admin/audit"><?= View::t('audit') ?></a><a class="nav-button<?= str_starts_with($requestPath,'/admin/settings')?' active':'' ?>" href="<?= View::e($basePath ?? '') ?>/admin/settings"><?= View::t('settings') ?></a><?php endif; ?><a class="nav-button<?= str_starts_with($requestPath,'/help')?' active':'' ?>" href="<?= View::e($basePath ?? '') ?>/help"><?= View::t('help') ?></a>
...
<?php if($user): ?><a class="scroll-top" href="#top" title="<?= View::e(View::t('back_to_top')) ?>" aria-label="<?= View::e(View::t('back_to_top')) ?>">↑</a><?php endif; ?></body></html>
